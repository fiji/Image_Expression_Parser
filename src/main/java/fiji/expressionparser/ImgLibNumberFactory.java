 ...
 * representation of number within the expression parser logic. For coherence
 * with ImgLib, we choose to represent number as ImgLib types, and choose the
 * concrete {@link FloatType} class.
 * <p>
 * As of now, we do not deal with complex numbers. Everytime we meet a complex
 * number, we take only its real part.
 * 
