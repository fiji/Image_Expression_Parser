		...
		implements ImgLibFunction< T >
{
	...
	/**
	 * Evaluate this function on two ImgLib images. A new {@link Img} of
	...
	/**
	 * Evaluate this function on an ImgLib images and a numeric {@link RealType}
	 * type, right singleton expansion. A new {@link Img} of {@link FloatType}
	...
	/**
	 * Evaluate this function on an ImgLib images and a numeric {@link RealType}
	 * type, left singleton expansion. A new {@link Img} of {@link FloatType} is
	 ...
	 * method {@link #evaluate(Img, Img)}, as meant by the implement function.
	 * 
	 * @param img
	 *            the image
	 * @param alpha
